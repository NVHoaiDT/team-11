                  ...
                  <td>
                    <c:choose>
                      <c:when test="${entry.furnitureStatus == 'STOP_SELLING'}">
                        ...
                        <span class="badges bg-lightred">${entry.furnitureStatus}</span>
                      </c:when>
                      <c:otherwise>
                        <!-- Nếu trạng thái không phải là 'STOP_SELLING', sử dụng màu xanh -->
                        <span class="badges bg-lightgreen">${entry.furnitureStatus}</span>
                      </c:otherwise>
                    </c:choose>
                  </td>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    rows.forEach(row => {
      ...
      if (EFurnitureStatus && EFurnitureStatus.textContent === 'STOP_SELLING') {
